...
"""PyInstaller onedir spec for the Windows freeze (CPU torch).

This is the only Windows freeze: CPU torch, CUDA binaries filtered,
matplotlib excluded. Same entry (cleave.py), EXE name cleave, COLLECT
