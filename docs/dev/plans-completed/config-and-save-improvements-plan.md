...
- **Never open the template as the live session.** If there is no project, show the picker ([file-picker-plan.md](../plans/file-picker-plan.md)).
...
- Last-opened project and last browse directory in user config (also in [file-picker-plan.md](../plans/file-picker-plan.md)).
...
- Mid-session Open ([file-picker-plan.md](../plans/file-picker-plan.md) Phase 3). That work should reuse the same unsaved-project prompt once this plan lands.
