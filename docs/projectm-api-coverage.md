...
| `projectm_playlist_add_presets` | bound, used | Ordered `preset_switching_list` when trigger is projectM |
| `projectm_playlist_set_shuffle` | bound, used | Forced off for list order (no session shuffle field) |
