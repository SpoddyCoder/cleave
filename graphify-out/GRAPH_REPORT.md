...
## Corpus Check
- 179 files · ~131,600 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3496 nodes · 12058 edges · 101 communities (99 shown, 2 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 583 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `332d464f`
...
Cohesion: 0.04
Nodes (138): hard_cut_enabled_display(), preset_start_clean_display(), ui_fade_display(), _apply_expand_subheader(), apply_field_horizontal(), _apply_render_overlay_body_font(), _apply_render_overlay_body_font_size(), _apply_render_overlay_border_width() (+130 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (94): panel_content_max_width(), Top-left x, y, width, height of the last drawn panel, if any., Return the VALUE-role color for a row (before label/value split rendering)., Content width budget for a row; scrollable rows reserve the scrollbar column., Tree-style live tuning panel; holds visible after input, then fades out., _row_bg_color(), _row_has_tree_focus(), _row_highlight_color() (+86 more)
...
Cohesion: 0.03
Nodes (71): Event, FocusCursor, Path, Return True when a modal dialog consumed the event., Handle a key down event for the main tuning tree., Keyboard focus machine for the live tuning tree overlay., TuningControls, _open_timeline_panel() (+63 more)
...
Cohesion: 0.06
Nodes (96): Offline render output frame rate from config., render_fps(), RenderConfig, RenderPostFxConfig, _build_render_overlay_background(), _build_render_overlay_border(), _build_render_overlay_config(), _build_render_overlay_text_block() (+88 more)

### Community 10 - "Community 10"
Cohesion: 0.09
Nodes (62): RenderOverlayBackgroundConfig, RenderOverlayBorderConfig, RenderOverlayConfig, RenderOverlayTextBlockConfig, _composite_render_overlay(), ensure_render_overlay_panel(), Surface, Shared content-frame finish for live play and offline render.  After layer compo (+54 more)

### Community 11 - "Community 11"
Cohesion: 0.09
Nodes (20): snapshot_monitor_from_output(), current_sec(), init_playback(), PlaybackState, Playback timing and seek helpers for the visualizer., seek(), toggle_pause(), Event (+12 more)

### Community 12 - "Community 12"
Cohesion: 0.13
Nodes (29): clamp_effect_pct(), Shared clamps and per-driver pulse envelope constants., _apply_flare(), FlareBurstState, Per-layer bloom flare: onset delta and threshold burst (drums only)., _update_flare(), _apply_flash(), FlashBurstState (+21 more)
...
Cohesion: 0.14
Nodes (45): TimelineCue, build_record_punch_cues(), build_timeline_view_state(), effective_layer_enabled(), FocusCursor, Cues to punch on record stop: baseline, toggles, and committed restore at stop., _slot_has_t0_cue(), timeline_committed_visible() (+37 more)

### Community 15 - "Community 15"
Cohesion: 0.11
Nodes (52): _mutate_timeline_arm(), _mutate_timeline_preview_pause(), _mutate_timeline_recording_start(), _make_timeline_controls(), Unit tests for timeline panel keyboard controls., test_ctrl_enter_noop_while_recording(), test_ctrl_seek_when_not_recording(), test_ctrl_space_starts_record_when_paused() (+44 more)

### Community 16 - "Community 16"
Cohesion: 0.10
Nodes (38): append_expand_section_rows(), append_render_section_rows(), _append_section_nodes(), append_track_section_rows(), _assign_expand_indent_depth(), _assign_indent_depth(), _build_row_tree_indent_depth(), _build_section_header_parent_map() (+30 more)

### Community 17 - "Community 17"
Cohesion: 0.15
Nodes (36): prune_expired_arm_flashes(), Bottom-anchored timeline panel drawn over the composited frame., Last draw bar metrics: ``(bar_left, bar_width, eye_slot_w)`` in panel coordinate, Last draw layout: ``(row_index, x, y, w, h, stem)`` in panel coordinates., TimelineOverlay, unique_cue_times(), _abbrev_bg_pixel(), _draw() (+28 more)
...
Cohesion: 0.07
Nodes (31): cursor_main_descriptor(), build_layout_frame(), Row layout and visibility/navigability for the live tuning overlay., Count of scrollable content rows (all rows except pinned header rows)., Row indices drawn in the panel (sub-rows hidden when collapsed)., Row indices reachable via Up/Down (sub-rows skipped when collapsed)., Row indices for Ctrl+Up/Down: settings, transport, layer, and render headers., resolve_navigable_descriptor() (+23 more)

### Community 20 - "Community 20"
Cohesion: 0.14
Nodes (28): DescriptionSection, ComposedHelpPanel, Context-sensitive help panel for the Cleave visualizer., compute_help_panel_size(), _entry_gap(), _entry_width(), _help_flag_variants(), help_panel_max_dimensions() (+20 more)

### Community 21 - "Community 21"
Cohesion: 0.20
Nodes (16): panel_content_max_width_px(), Shared colors and layout constants for Milkdrop live tuning UI panels.  Typograp, Map persisted ui_width (20-200) to scaled panel content max width in pixels., scale_px(), timeline_ui_metrics(), TimelineUiMetrics, tuning_ui_metrics(), TuningUiMetrics (+8 more)

### Community 22 - "Community 22"
Cohesion: 0.10
Nodes (40): load_mix_pcm(), load_wav_pcm_44k(), ndarray, Path, Shared PCM loading for stems and mix playback., Load a wav as float32 PCM at 44.1 kHz in native channel layout., Load mix audio as interleaved stereo float32 at 44.1 kHz., _resample_stereo_interleaved() (+32 more)
...
Cohesion: 0.09
Nodes (50): FocusContext, Shared focus and view-state access for tuning sub-controllers., build_focus_ring(), cursor_timeline_row(), cursor_timeline_submenu_focused(), MainFocus, move_focus(), FocusCursor (+42 more)
...
Cohesion: 0.14
Nodes (46): Return the repository root directory., repo_root(), _default_output_path(), _is_partial_segment(), _progress(), Path, Ensure *project_dir* is ready for offline render; return resolved path., Render project visuals to an MP4 muxed with the project mix audio. (+38 more)
...
Cohesion: 0.10
Nodes (56): format_fps_display(), _bar_width(), _icon_height(), material_font(), Font, Surface, Material Icons rendering for the live tuning overlay., render_glyph() (+48 more)

### Community 31 - "Community 31"
Cohesion: 0.12
Nodes (28): Fixed eye slot width (glyph plus horizontal pad for solo background)., visibility_icon_slot_width(), Scaled bottom timeline strip height in pixels., timeline_panel_height_px(), bar_segments_for_row(), bar_tick_times_for_row(), _clip_segments(), layer_num_prefix() (+20 more)
...
Cohesion: 0.10
Nodes (39): LiveVisualizerRuntime, Fully initialized live visualizer runtime., dispatch_keydown(), dispatch_keyup(), dispatch_should_notify_overlay(), _handle_global_keydown(), key_handler_for_runtime(), Event (+31 more)
...
Cohesion: 0.14
Nodes (29): OverlayTextureSlot, OpenGL FBO layer stack and black-key compositing., clip_dirty_rects(), OverlayGpuState, OverlayUploadCoordinator, Surface, GPU overlay upload planning and execution for stable-size textures., Stateless coordinator for stable-size overlay texture uploads. (+21 more)

### Community 39 - "Community 39"
Cohesion: 0.19
Nodes (24): _coordinator_upload(), _help_compose_kwargs(), _note_upload(), OverlayDrawer, _present_overlay(), Surface, GL upload path for live tuning and timeline overlays., Upload pygame overlay surfaces to the display framebuffer. (+16 more)

### Community 40 - "Community 40"
Cohesion: 0.12
Nodes (40): _live_overlay_ui_active(), _tuning_view_state_needed(), VisualizerApp, draw_loading_screen(), _loading_font_get(), Font, Centered loading message during visualizer boot., _heavy_init_side_effect() (+32 more)
...
Cohesion: 0.12
Nodes (24): Anchor, ensure_row_surface(), live_upload_signature(), panel_signature(), PanelSignature, Font, Surface, Retained surfaces and signatures for the live tuning panel. (+16 more)
...
Cohesion: 0.19
Nodes (11): arm_abbrev_flash_active(), arm_abbrev_flash_visible(), armed_abbrev_bg_visible(), Surface, rec_flash_visible(), _TimelineLayout, TimelineViewState, TimelinePanelCache (+3 more)
...
Cohesion: 0.12
Nodes (39): load_manifest(), manifest_path(), mix_path(), ProjectManifest, Path, Project manifest (project.yaml) for Cleave projects., Update ``project.yaml`` *slug* and optional ``restored-from`` provenance., resolve_mix_path() (+31 more)

### Community 55 - "Community 55"
Cohesion: 0.12
Nodes (16): ModalHost, ModalKind, ModalOption, ModalRequest, Event, Centered confirm modal host for live tuning UI., Return True when the event is consumed (including while blocking)., Modal prompt host; consumes keys while active. (+8 more)
...
Cohesion: 0.13
Nodes (27): Shared frame tick for live and render. Returns updated was_paused., tick_frame_core(), _apply_layer_bloom(), _apply_layer_grit(), _beat_sensitivity(), LayerFramePipeline, Path, Per-frame GL pipeline for stem layers. (+19 more)
...
Cohesion: 0.14
Nodes (22): format_mmss(), timeline_live_signature(), transport_time_text(), _cue_fingerprint(), Retained surfaces and signatures for the bottom timeline strip., Everything affecting strip chrome except live transport/playhead., timeline_static_signature(), timeline_upload_signature() (+14 more)
...
Cohesion: 0.13
Nodes (24): _derived_blocked_by_layer_lock(), _derived_navigable_when_layer_locked(), expandable_row_kinds(), Row interaction semantics for the live tuning overlay., True when Delete should prompt to remove the focused track block's layer., row_behavior(), row_blocked_by_layer_lock(), row_is_pinned() (+16 more)
...
Cohesion: 0.29
Nodes (15): _controls_with_playlist(), _make_sibling_dir_tree(), _preset_dir_row(), Return (preset_root, sibling_dirs) each with at least one .milk file., test_backspace_at_preset_root_is_noop(), test_ctrl_left_at_preset_root_is_noop(), test_directory_ctrl_arrows_descend_and_ascend(), test_directory_ctrl_arrows_do_not_repeat_parent_climb() (+7 more)

### Community 67 - "Community 67"
Cohesion: 0.28
Nodes (9): visibility_icon_prefix_width(), _overlay_font(), Font, test_config_header_truncates_long_paths(), test_fit_row_text_config_and_preset_share_panel_width(), test_track_header_icons_render(), test_track_header_prefix_width_matches_visibility_icon(), baseline_tuning_ui_metrics() (+1 more)
...
Cohesion: 0.16
Nodes (16): HelpOverlay, Font, HelpContent, Surface, Read-only help panel anchored top-right; visibility from session state., help_content_signature(), Tests for help panel cache and GPU upload signatures., test_compose_panel_cpu_cache_hit_reuses_panel_surface() (+8 more)
...
Cohesion: 0.13
Nodes (17): Stem layer data class., _anchor_visibility_for_slot(), armed_recording_defaults(), armed_recording_visible(), committed_visible_outside_punch(), Timeline visibility algebra and per-frame layer enablement., Visibility for a record-pass slot during an active take., Committed visibility at *record_stop* ignoring armed-slot cues inside the punch. (+9 more)
...
Cohesion: 0.50
Nodes (4): cue_times_for_stem(), Cue times that change visibility for *slot* within ``[0, duration_sec]``., test_cue_times_for_stem_only_includes_relevant_layers(), test_cue_times_for_stem_skips_show_tick_false()
...
Cohesion: 0.05
Nodes (155): _row_text(), _mutate_layer_z_order(), _desc(), _expand_settings(), _expand_settings_ui(), _focus_index(), _keydown(), _make_controls() (+147 more)
...
Cohesion: 0.06
Nodes (46): GlPostProcess, Separable bloom pass on an existing layer FBO texture., Attach to the current pygame OpenGL context., ndarray, StemSource, Preloaded per-stem PCM at 44.1 kHz for libprojectM audio feed., Preloaded float32 PCM for *stem* (mono 1D or interleaved stereo)., Channel count for *stem* (1 mono, 2 interleaved stereo). (+38 more)
...
Cohesion: 0.07
Nodes (36): Focus-driven live tuning input for the Milkdrop visualizer overlay., apply_effect_modifiers(), apply_layer_visibility(), LiveLayerBindings, Live layer sync handlers for tuning controls., PanelNotificationHost, Pinned header notification timing for the live tuning panel., Single-slot notification state with monotonic expiry. (+28 more)
...
Cohesion: 0.14
Nodes (24): allow_overwrite_for_path(), config_path_display(), Path, Active config path for the config header row (truncation happens at draw time)., Hide overwrite only for the repo-root template cleave-viz.yaml., _choose_overwrite(), _choose_save_as_new(), _config_header_row() (+16 more)
...
- **Why does `TuningSession` connect `Community 98` to `Community 0`, `Community 1`, `Community 4`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 14`, `Community 15`, `Community 25`, `Community 27`, `Community 28`, `Community 33`, `Community 34`, `Community 35`, `Community 40`, `Community 48`, `Community 49`, `Community 50`, `Community 51`, `Community 55`, `Community 57`, `Community 58`, `Community 60`, `Community 63`, `Community 64`, `Community 66`, `Community 72`, `Community 74`, `Community 84`, `Community 90`, `Community 94`?**
  _High betweenness centrality (0.095) - this node is a cross-community bridge._
- **Why does `TuningControls` connect `Community 6` to `Community 0`, `Community 2`, `Community 8`, `Community 11`, `Community 12`, `Community 15`, `Community 16`, `Community 19`, `Community 25`, `Community 30`, `Community 33`, `Community 40`, `Community 48`, `Community 49`, `Community 55`, `Community 60`, `Community 66`, `Community 74`, `Community 84`, `Community 90`, `Community 94`, `Community 98`, `Community 102`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `GlCompositor` connect `Community 105` to `Community 33`, `Community 98`, `Community 38`, `Community 39`, `Community 40`, `Community 10`, `Community 20`, `Community 85`, `Community 86`, `Community 88`, `Community 94`, `Community 93`, `Community 62`, `Community 57`?**
