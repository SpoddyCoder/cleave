    ...
    def build(
        ...
        *,
        ...
        return TuningViewState(
            ...
            confirm_message=self._config_save.confirm_message,
            confirm_focus_yes=self._config_save.confirm_focus_yes,
            save_choice_active=self._config_save.save_choice_active,
            save_choice_focus_overwrite=self._config_save.save_choice_focus_overwrite,
            unsaved_quit_active=self._config_save.unsaved_quit_active,
            unsaved_quit_focus=self._config_save.unsaved_quit_focus,
